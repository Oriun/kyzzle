...
export function listSchemaItems(schemas, executor) {
  ...
  `;
        const { rows } = yield executor.query(query);
        return object({
            type: _enum(["r", "v", "m", "c", "e", "f"]).transform((v) => ({
                r: "table",
                v: "view",
                m: "matview",
                c: "composite type",
...
export function listTableItems(table, executor) {
    return __awaiter(this, void 0, void 0, function* () {
        const query = sql `
    WITH
        -- Basic table info
        ...
        ;
  `;
        const { rows } = yield executor.query(query, table.split("."));
        return object({
            table: object({
                table_schema: string(),
                table_name: string(),
...
export function listCompositeTypeItems(type, executor) {
    return __awaiter(this, void 0, void 0, function* () {
        const query = sql `
    WITH
      type_info AS (
    ...
    FROM type_info ti;
  `;
        const { rows } = yield executor.query(query, type.split("."));
        return object({
            type_schema: string(),
            type_name: string(),
            fields: object({
...
export function listEnumTypeItems(type, executor) {
    return __awaiter(this, void 0, void 0, function* () {
        const query = sql `
      SELECT
        n.nspname       AS type_schema,
...
export function getViewQuery(view, executor) {
    return __awaiter(this, void 0, void 0, function* () {
        const query = sql `
    SELECT pg_get_viewdef($1::regclass) as definition;
  `;
        const { rows } = yield executor.query(query, [view]);
        return object({
            definition: string(),
        })
            .array()
